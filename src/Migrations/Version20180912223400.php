 ...
 */
final class Version20180912223400 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE volunteer CHANGE availability availability LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
        $this->addSql('ALTER TABLE event CHANGE data data LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE data data LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE volunteer CHANGE availability availability LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
